...
## Environments
- Preview: https://main--meejain-swbc--aemysites.aem.page/
- Live: https://main--meejain-swbc--aemysites.aem.live/
- Block Library: https://main--meejain-swbc--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `meejain-swbc` directory in your favorite IDE and start coding :)
